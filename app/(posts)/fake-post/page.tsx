...
export default async function FakePostPage() {
	...
	const mockNextPost = {
		slug: "fake-post",
		title: "Understanding Cache Components and Webhooks",
		description:
			"Learn how cache components work with GitHub webhooks to keep your content fresh without full rebuilds.",
