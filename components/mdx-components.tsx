...
export const MdxComponents = {
  h1: (props: ComponentPropsWithoutRef<"h1">) => <h1 className="text-4xl font-bold mb-6 text-balance" {...props} />,
  h2: (props: ComponentPropsWithoutRef<"h2">) => (
    <h2 className="text-3xl font-bold mt-12 mb-4 text-balance" {...props} />
  ),
  h3: (props: ComponentPropsWithoutRef<"h3">) => (
    <h3 className="text-2xl font-semibold mt-8 mb-3 text-balance" {...props} />
  ),
  p: (props: ComponentPropsWithoutRef<"p">) => <p className="leading-relaxed mb-4 text-pretty" {...props} />,
